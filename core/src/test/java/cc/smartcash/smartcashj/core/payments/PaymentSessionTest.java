...
package cc.smartcash.smartcashj.core.payments;
...
public class PaymentSessionTest {
    ...
    public void testSimplePayment() throws Exception {
        ...
        Assert.assertEquals(paymentRequestMemo, paymentSession.getMemo());
        Assert.assertEquals(coin, paymentSession.getValue());
        Assert.assertEquals(simplePaymentUrl, paymentSession.getPaymentUrl());
    ...
    public void testDefaults() throws Exception {
        ...
        Assert.assertEquals(Coin.ZERO, paymentSession.getValue());
    ...
    public void testWrongNetwork() throws Exception {
        ...
        Assert.assertEquals(MAINNET, paymentSession.getNetworkParameters());
