...
public class PeerAddressTest {
    ...
    public void parse_ancientProtocolVersion() throws Exception {
        ...
        Assert.assertEquals(VersionMessage.NODE_NETWORK, pa.getServices().longValue());
    ...
    public void bitcoinSerialize_ancientProtocolVersion() throws Exception {
        ...
        assertEquals(26, pa.length);        
        Assert.assertEquals("000000000000000000000000000000000000ffff7f000001208d", Utils.HEX.encode(pa.bitcoinSerialize()));
    }
