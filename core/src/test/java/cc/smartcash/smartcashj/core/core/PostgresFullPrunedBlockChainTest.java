...
package cc.smartcash.smartcashj.core.core;

import cc.smartcash.smartcashj.core.AbstractFullPrunedBlockChainTest;
...
import cc.smartcash.smartcashj.store.PostgresFullPrunedBlockStore;
import cc.smartcashj.core.AbstractFullPrunedBlockChainTest;
...
public class PostgresFullPrunedBlockChainTest extends AbstractFullPrunedBlockChainTest
{
    ...
    // You can set up a fresh postgres with the command: create user smartcashj superuser password 'password';
    private static final String DB_HOSTNAME = "localhost";
    private static final String DB_NAME = "bitcoinj_test";
    private static final String DB_USERNAME = "smartcashj";
