...
package cc.smartcash.smartcashj.core.store;
...
import cc.smartcash.smartcashj.core.core.BlockTest;
...
import cc.smartcash.smartcashj.core.testing.FakeTxBuilder;
import cc.smartcash.smartcashj.core.testing.FooWalletExtension;
...
import static cc.smartcash.smartcashj.core.testing.FakeTxBuilder.createFakeTx;
...
public class WalletProtobufSerializerTest {
    ...
    public void oneTx() throws Exception {
        ...
        Coin v1 = COIN;
        Transaction t1 = FakeTxBuilder.createFakeTx(UNITTEST, v1, myAddress);
    ...
    public void testSequenceNumber() throws Exception {
        Wallet wallet = new Wallet(UNITTEST);
        Transaction tx1 = FakeTxBuilder.createFakeTx(UNITTEST, Coin.COIN, wallet.currentReceiveAddress());
        tx1.getInput(0).setSequenceNumber(TransactionInput.NO_SEQUENCE);
        wallet.receivePending(tx1, null);
        Transaction tx2 = FakeTxBuilder.createFakeTx(UNITTEST, Coin.COIN, wallet.currentReceiveAddress());
