...
package cc.smartcash.smartcashj.core.utils;

import cc.smartcash.smartcashj.core.Coin;
import cc.smartcash.smartcashj.utils.BtcAutoFormat;
import cc.smartcash.smartcashj.utils.BtcFixedFormat;
import cc.smartcash.smartcashj.utils.BtcFormat;
    ...
    public void symbolCollisionTest() {
        ...
        for (int i = 0; i < locales.length; ++i) {
            ...
            if (cs.contains("฿")) {
                ...
                Assert.assertEquals("Ƀ", ((BtcFixedFormat)ff).symbol());
