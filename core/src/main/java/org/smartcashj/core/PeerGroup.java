...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of smartcashj fixes the known
     ...
     * and easy way for a user to upgrade a smartcashj based app running in SPV mode to fully validating security.
     */
