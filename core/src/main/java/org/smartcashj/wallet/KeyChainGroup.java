...
public class KeyChainGroup implements KeyBag {
     ...
     * @see org.smartcashj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.smartcashj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.smartcashj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
