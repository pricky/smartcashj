...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws cc.smartcash.smartcashj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws cc.smartcash.smartcashj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
