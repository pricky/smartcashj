...
public class ECKey implements EncryptableItem {
     ...
     * @throws cc.smartcash.smartcashj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
    ...
    public String signMessage(String message, @Nullable KeyParameter aesKey) throws KeyCrypterException {
        ...
        Sha256Hash hash = Sha256Hash.wrap(Sha256Hash.hash(data));
    ...
    public static ECKey signedMessageToKey(String message, String signatureBase64) throws SignatureException {
        ...
        Sha256Hash messageHash = Sha256Hash.wrap(Sha256Hash.hash(messageBytes));
     ...
     * @throws cc.smartcash.smartcashj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
