...
public interface FullPrunedBlockStore extends BlockStore, UTXOProvider {
     ...
     */
    StoredBlock getOnceUndoableStoredBlock(Keccak256Hash hash) throws BlockStoreException;
     ...
     */
    StoredUndoableBlock getUndoBlock(Keccak256Hash hash) throws BlockStoreException;
