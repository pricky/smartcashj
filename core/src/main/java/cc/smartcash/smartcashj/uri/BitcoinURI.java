...
import cc.smartcash.smartcashj.params.AbstractBitcoinNetParams;
 ...
 *
 * <ul>
 * <li>{@code smartcash:<address>}</li>
 * <li>{@code smartcash:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
     ...
     */
    @Deprecated
    public static final String BITCOIN_SCHEME = "smartcash";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  smartcash:<address>?<query parameters>
        ...
        // For instance with : smartcash:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the smartcash: prefix");
    ...
    private void parseParameters(@Nullable NetworkParameters params, String addressToken, String[] nameValuePairTokens) throws BitcoinURIParseException {
        ...
        for (String nameValuePairToken : nameValuePairTokens) {
            ...
            if (sepIndex == -1)
                throw new BitcoinURIParseException("Malformed Smartcash URI - no separator in '" +
                        nameValuePairToken + "'");
            if (sepIndex == 0)
                throw new BitcoinURIParseException("Malformed Smartcash URI - empty name '" +
                        nameValuePairToken + "'");
