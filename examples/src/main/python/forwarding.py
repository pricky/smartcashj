...
sys.path.append(r"/path/to/smartcashj-core-0.12-bundled.jar")
...
if __name__ == "__main__":
    params = cc.smartcash.smartcashj.params.TestNet3Params.get()
